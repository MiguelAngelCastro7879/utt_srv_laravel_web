        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
            ...
            {{-- <div class="block mt-4"> --}}
                <label for="remember_me" class="inline-flex items-center">
                    <span class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{{ __('Validacion de actualizaciones') }}</span>
                </label>
                <br><br>
                <p class="font-semibold text-x2 text-gray-800 dark:text-gray-200 leading-tight">Puedes enviar un email con un token unico a los usuarios para actualizar un registro</p>
                <br>
            {{-- </div> --}}
                <div style="width: 100%; height 100%; display:flex; flex-wrap:wrap; zoom: 55%; align-content: center;">
                    ...
                    <div class="card">
                        ...
                        <div class="card-stats" >
                            <button class="stat" style="border-bottom-left-radius: 15px; background: rgb(6, 163, 40);" onclick="window.location='/api/enviar/codigo/actualizar/{{ $peticion->id }}'">
