...
Route::get('/code/upd', [GamesCodesController::class, 'show_code'])->name('show_code_user'); // Esta es la vista que se le meustra al usuario
...
Route::get('/code/dest', [GamesCodesController::class, 'show_code_destroy'])->name('show_code_destroy_user'); // Esta es la vista que se le meustra al usuario
